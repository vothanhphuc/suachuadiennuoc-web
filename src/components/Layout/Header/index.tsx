    ...
    >
      <div className="lg:py-0 py-2">
        <div className="container mx-auto lg:max-w-screen-xl md:max-w-screen-md flex items-center justify-between px-4">
          ...
          <div
            className={`flex items-center gap-4 pl-10 border-l border-black/60 duration-300 ${sticky ? "py-3" : "py-7"
              }`}
          >
            {/* <button
            ...
            >
              <a href="tel:+84901413079">HotLine:090.141.3079</a>
            </button>
            {isSignInOpen && (
